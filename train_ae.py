...
from src.data.datasets import AutoEncoderPromptDataset
...
if config.model_type.startswith('gpt'):
    ...
    DatasetClass = AutoEncoderPromptDataset
...
#     DatasetClass = AutoEncoderDataset
    ...
    raise NotImplementedError('Only gpt.')
